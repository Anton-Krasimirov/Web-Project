...
class CreatCarProfileForm(forms.ModelForm, BootstrapFormMixin):
    ...
    class Meta:
        model = Car
        fields = ('brand', 'model', 'body_style', 'km', 'first_reg_date', 'transmission', 'fuel', 'color', 'price',
...
class CreatTruckProfileForm(forms.ModelForm, BootstrapFormMixin):
    ...
    class Meta:
        model = Truck
        fields = ('brand', 'model', 'category', 'kilometers', 'first_reg_date', 'transmission', 'fuel', 'color', 'price',
                  'photo1', 'photo2', 'photo3', 'photo4')
        widgets = {
            'first_reg_date': forms.TextInput(
                attrs={'placeholder': 'Fill in this format - 31/12/0000',}
